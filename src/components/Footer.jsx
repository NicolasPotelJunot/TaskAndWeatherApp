...
export const Footer = () => {
  return (
    <footer class="mt-10 h-24 self-end footer items-center px-6 bg-neutral text-neutral-content">
        ...
        <div class="grid-flow-col gap-4 h-full items-center md:justify-self-end">
            ...
            <a className='text-4xl cursor-pointer hover:text-orange-800' href="https://www.instagram.com/nicopjm/?hl=es-la" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faInstagram} /></a>
        </div>
    </footer>
  )
}
