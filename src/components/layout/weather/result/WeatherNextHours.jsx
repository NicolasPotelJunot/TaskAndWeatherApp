export const WeatherNextHours = ({ forecast, weather }) => {
  ...
  return (
    <div className="py-6 md:py-10 md:px-10 lg:py-6 rounded-2xl">
      ...
      <div className="grid grid-cols-3 gap-10 md:gap-3 2xl:gap-0 items-start">
        <article className=" text-center grid justify-center pt-4">
          ...
          <p className="bg-btn-violet-noHover text-white rounded-xl m-auto py-2 px-2 md:px-4 text-xs md:text-sm text-center">
